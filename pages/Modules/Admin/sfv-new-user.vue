        ...
        async onCreateStaff() {
            ...
            this.$swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    console.log(
                        "this.name && this.nricno &&  this.rolelist2 && this.email && this. && this.company_name &&this.address_vacs_factory && this.designationId && this.designationstartdate && this.designationenddate &&this.branchId && this.startdate && this.enddate && !this.nricerror",
                        this.name,
                        this.nricno,
                        this.BranchAddress1,
                        this.BranchAddress2,
                    ...
                    if (
                        ...
                        body.append("nric_no", this.BranchAddress1);
                        body.append("nric_no", this.BranchAddress2);
                        body.append("nric_no", this.BranchAddress3);
                        body.append("state", this.State);
                        body.append("city", this.City);
                        body.append("postcode", this.Postcode);
                        body.append("email", this.email);
                        body.append("role_id", this.rolelist2); //check

                        body.append("branch_id", this.branchId);
                        body.append("contact_no", this.contactno);
                        body.append("name_vacs_manufacturer", this.company_name);
                        body.append("address_vacs_factory", this.company_addr);
