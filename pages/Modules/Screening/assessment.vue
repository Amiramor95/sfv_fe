      ...
      <main>
        <div class="container-fluid px-4">
          <div class="page-title">
            <h1>Senarai Proses Penilaian</h1>
          </div>
          <div class="card mb-4">
            <div class="card-body">
              ...
              <table  class="table table-striped data-table font-13" style="width: 100%">
                ...
                <tbody>
                    <tr v-for="(vac,index) in list" :key="index"> <!--this list is retrieved from vaccine_reg joined with multiple tables-->
                      ...
                      <td> Proses Penilaian</td><!--from "vaccine_reg" table-->
                      <td>
                      <a @click="view(vac.id)" class="view" title="Semakan Penilaian"><em class="fa fa-eye"></em></a>
                      <a @click="edit(vac.id)" class="view" title="Tindakan Penilaian"><em class="fa fa-edit"></em></a>
                      </td>
                    </tr>
                </tbody>
              </table>
